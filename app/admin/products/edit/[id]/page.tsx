...
export default function EditProductPage({ params }: { params: { id: string } }) {
    ...
    if (loading) return <div className="p-10 text-center">Cargando datos del producto...</div>;
    if (error && !formData.name) return <div className="p-10 text-center text-red-600">{error}</div>;
